          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                <form class="navbar-form" action="customerSearch.php?userid=<?php echo $userid;?>" method="Post">
...
<td>{$data['email']}</td>
<td>{$data['address']}</td>
<td><a href='editcustomer.php?id=".$data['id']."&userid=$userid' class='btn btn-default' >Edit</a></td>                    
<td><a href='delcustomer.php?id=".$data['id']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
...
echo $main;
echo "</table>";
echo "<br /><a href=customer.php?page=1&userid=$userid>最前</a> ";
echo "第 ";
for( $i=1 ; $i<=$pages ; $i++ ) {
