          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                <form class="navbar-form" action="DA_Search.php" method="Post">
...
<td>{$data['address']}</td>
<td><a href='editDA.php?id=".$data['id']."' class='btn btn-default' >Edit</a></td>                    
<td><a href='delDA.php?id=".$data['id']."' class='btn btn-link'>Delete</a></td>
 </tr>
";
