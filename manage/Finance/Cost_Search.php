          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                 <form class="navbar-form" action="Cost_Search.php?userid=<?php echo $userid;?>" method="Post">
				<select  name="month">
			  ...
			  <?php $m=$_POST['month'];?>
                <h4 class="margin-bottom-15"><?php echo $m?>月 Cost Detailed List</h4>
...
//設定SQL語法
$m=$_POST['month'];
$sql="select * from purchase_data where  month(purchasedate)='".$m."'";
