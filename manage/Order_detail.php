          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                ...
                <form class="navbar-form" action="OrderD_Search.php" method="Post">
...
$sqlstr = "SELECT * FROM order_detail ORDER BY no ASC"; //修改成你要的 SQL 語法
...
<td>{$data['quantity']}</td>
<td>{$data['revenue']}</td>
<td><a href='editOrder_D.php?id=".$data['no']."' class='btn btn-default' >Edit</a></td>                    
<td><a href='delOrder.php?id=".$data['no']."' class='btn btn-link'>Delete</a></td>
 </tr>
";
...
echo $main;
echo "</table>";
echo "<br /><a href=Order_detail.php?page=1>最前</a> ";
echo "第 ";
for( $i=1 ; $i<=$pages ; $i++ ) {
