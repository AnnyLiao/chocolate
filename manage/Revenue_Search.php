          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                 <form class="navbar-form" action="Revenue_Search.php" method="Post">
				<select  name="month">
			  ...
			  <?php $m=$_POST['month'];?>
                <h4 class="margin-bottom-15"><?php echo $m?>月 Revenue Detailed List</h4>
...
//設定SQL語法
$m=$_POST['month'];
$sql="select * from order_data where  month(date)='".$m."'";
...
$result = mysql_query($sql) or die("error");
				  ...
				  $s3="select SUM(quantity) AS num_sum, SUM(revenue) AS revenue_sum, productNo, no from order_detail where no='".$data['no']."'";

//執行SQL語法

$r3 = mysql_query($s3) or die("error");

				  while($d2=mysql_fetch_assoc($r3)){
				  $quantity=$d2['num_sum'];
				  $revenue=$d2['revenue_sum'];
				  /*$s2="select * from chocolate where id='".$d2['productNo']."'";
