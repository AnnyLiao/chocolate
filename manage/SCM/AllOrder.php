          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
               ...
               <form class="navbar-form" action="Order_Search.php" method="GET">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">All Orders Table</h4>
...
$sqlstr = "SELECT * FROM order_data ORDER BY no DESC"; //修改成你要的 SQL 語法
...
echo $main;
echo "</table>";
echo "<br /><a href=AllOrder.php?page=1&userid=$userid>最前</a> ";
echo "第 ";
for( $i=1 ; $i<=$pages ; $i++ ) {
