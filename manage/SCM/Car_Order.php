...
$dt1=date('Y-m-d');
	...
	if(isset($_GET['id'])){
		...
		while($data=mysql_fetch_assoc($result)){
			...
			$s4="insert into `order_detail` (`productNo`, `quantity`, `cost`, `revenue`, `profit`) VALUES ('".$productNo."','".$num."','".$Cost."','".$revenue."','".$profit."')";
			...
			{
				echo "<script>";
				echo "alert(\"新增成功\");location:indexEnter.php?id='".$id."';";
				echo "</script>";
