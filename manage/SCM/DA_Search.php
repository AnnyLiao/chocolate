...
<head>
  ...
  <title>Delivery Agency Search</title>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                <form class="navbar-form" action="DA_Search.php?userid=<?php echo $userid;?>" method="Post">
              ...
              <div class="table-responsive">
                ...
                <h4 class="margin-bottom-15">Delivery_Agency Table</h4>
...
//設定SQL語法
$id=$_POST['search'];
$sql="select * from delivery_agency where id='".$id."'";
...
<tr>
<td>{$data['id']}</td> 
<td>{$data['delivery_company']}</td>
<td>{$data['email']}</td>
<td>{$data['telephone']}</td>
<td>{$data['address']}</td>
<td><a href='editDA.php?id=".$data['id']."&userid=$userid' class='btn btn-default' >Edit</a></td>                    
<td><a href='delDA.php?id=".$data['id']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
