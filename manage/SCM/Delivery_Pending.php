          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Delivery Pending Table</h4>
...
$sql="select * from order_data where status='Delivery Pending' ORDER BY no DESC";
...
<td>{$data['address']}</td>
<td>{$data['phone']}</td>
<td><a href='editStatusTest.php?id=".$data['no']."&userid=".$userid."' class='btn btn-default' >Deliveried</a></td>
