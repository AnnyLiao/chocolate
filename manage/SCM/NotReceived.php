          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Not Received Table</h4>
...
<td><a href='editpurchase.php?id=".$data['id']."&userid=$userid' class='btn btn-default' >Edit</a></td>                    
<td><a href='delpurchase.php?id=".$data['id']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
