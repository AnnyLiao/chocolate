...
<li><a href="Order_detail.php">Order Detail</a></li> 			  
		  ...
		  <li><a href="ProductB.php">Message Board</a></li>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <a href="index.html.html" class="btn btn-primary">Yes</a>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                 <form class="navbar-form" action="Order_Search.php" method="Post">
              ...
              <div class="table-responsive">
                ...
                <h4 class="margin-bottom-15">History Order List</h4>
...
$m=$_GET['orderDate'];
$id=$_GET['id'];
$sqlstr = "SELECT * FROM order_data where date='".$m."' and status='Pending' ORDER BY no ASC"; //修改成你要的 SQL 語法
...
<td>{$data['address']}</td>
<td>{$data['phone']}</td>
<td><a href='editPendding.php?id=".$data['no']."&userid=".$id."&orderDate=".$m."' class='btn btn-default' >Delivery Pending</a></td>
...
echo $main;
echo "</table>";
echo "<br /><a href=Pendding_DS.php?page=1&id=".$id."&orderDate=".$m.">最前</a> ";
echo "第 ";
for( $i=1 ; $i<=$pages ; $i++ ) {
 if ( $page-3 < $i && $i < $page+3 ) {
  echo "<a href=?page=".$i."&id=".$id."&orderDate=".$m.">".$i."</a> ";
 }
 //if ( $i % 5 == 0 ) echo "<br />";
} //分頁頁碼
echo " 頁 <a href=?page=".$pages."&id=".$id."&orderDate=".$m.">最後</a><br /><br />";
