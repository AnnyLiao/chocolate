...
$sqlstr = "SELECT * FROM board where department='產品管理部' ORDER BY no ASC"; //修改成你要的 SQL 語法
...
<td><a href='delPBoard.php?id=".$data['no']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
...
echo $main;
echo "</table>";
echo "<br /><a href=ProductB.php?page=1&userid=$userid>最前</a> ";
echo "第 ";
for( $i=1 ; $i<=$pages ; $i++ ) {
