...
<td><a href='editproduct.php?id=".$data['id']."&userid=$userid' class='btn btn-default' >Edit</a></td>                    
<td><a href='delproduct.php?id=".$data['id']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
