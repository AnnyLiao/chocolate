...
$query3 = "UPDATE order_data SET customer='$customer', date = '$date', productname = '$product', address = '$address', phone = '$telephone', status = '$status', handle_by = '$handle_by' where no = '$id'";
...
if($q3 && $q4)
{
echo "<script>alert('修改成功'); location.href = 'Order.php';</script>";;
}
