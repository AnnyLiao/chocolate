          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Supplier Table</h4>
...
<tr>
<td>{$data['id']}</td> 
<td>{$data['suppliercompany']}</td>
<td>{$data['liaisionname']}</td>
<td>{$data['telephone']}</td>
<td>{$data['email']}</td>
<td>{$data['address']}</td>

<td><a href='editsupplier.php?id=".$data['id']."&userid=$userid' class='btn btn-default' >Edit</a></td>                    
<td><a href='delsupplier.php?id=".$data['id']."&userid=$userid' class='btn btn-link'>Delete</a></td>
 </tr>
";
