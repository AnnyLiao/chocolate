...
$query3 = "UPDATE member_data SET password = '$password', employeename = '$employeename', department = '$department' , position = '$position' , birthday = '$birthday' , telephone = '$telephone' , email = '$email' , address = '$address' where id = '$id'";
	
	
		$q3=mysql_query($query3) or die ("false4".mysql_error());
		$query4 = "UPDATE salary_data SET  employeename = '$employeename', department = '$department' , position = '$position'  where id = '$id'";
	
	
		$q4=mysql_query($query4) or die ("false4".mysql_error());
if($q3 && $q4)
{
