          ...
          <div class="row">
            <div class="col-md-12">
              <div class="btn-group pull-right" id="templatemo_sort_btn">
                 ...
                 <form class="navbar-form" action="employeeSearch.php" method="Post">
...
<td>{$data['email']}</td>
<td>{$data['address']}</td>
<td><a href='editemployee.php?id=".$data['id']."' class='btn btn-default' >Edit</a></td>                    
<td><a href='delemployee.php?id=".$data['id']."' class='btn btn-link'>Delete</a></td>
 </tr>
";
