...
$query3 = "UPDATE chocolate SET chocolatename = '$productname', supplier = '$supplier' , cost = '$cost' , salescost = '$salescost' , subcription = '$subcription' where id = '$id'";
	
	
		$q3=mysql_query($query3) or die ("false4".mysql_error());
if($q3)
{
header('location:allorderPro.php');
}
echo "<script>";
		echo "alert(\"修改成功\");";
		echo "</script>";
...
<div class="row">
				...
				<div class="row">
				  ...
				  <div class="col-md-6 margin-bottom-15">
                    <label for="firstName" class="control-label">Cost</label>
                    <input type="text" class="form-control" name="cost" value="<?php echo $query2['cost']; ?>">                  
                  </div>
				  </div>
				  <div class="row">
                  <div class="col-md-6 margin-bottom-15">
