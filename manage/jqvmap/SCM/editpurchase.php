...
<div class="row">
				...
				<div class="row">
                  ...
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" name="price" value="<?php echo $query2['price']; ?>">                  
                  </div>
				  <div class="col-md-6 margin-bottom-15">
                    <label for="firstName" class="control-label">Quantity</label>
                    <input type="text" class="form-control" name="quantity" value="<?php echo $query2['quantity']; ?>">                  
                  </div>
				  </div>
				  <div class="row">
				  <div class="col-md-6 margin-bottom-15">
                    <label for="firstName" class="control-label">Total</label>
                    <input type="text" class="form-control" name="total" value="<?php echo $query2['total']; ?>">                  
                  </div>
				  <div class="col-md-6 margin-bottom-15">
